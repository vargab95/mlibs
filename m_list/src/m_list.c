...
static void delete_any_by_value(m_list_t *list,
                                const m_com_sized_data_t *const value,
                                boolean multi);
static void append_to_end_any(m_list_t *list,
                              const m_com_sized_data_t *const value,
                              boolean copy);
static void append_to_beginning_any(m_list_t *list,
                                    const m_com_sized_data_t *const value,
                                    boolean copy);
static void conditional_copy(const m_com_sized_data_t *const src,
                             m_com_sized_data_t *dst, boolean copy);
...
void m_list_append_to_end_set(m_list_t *list,
                              const m_com_sized_data_t *const value) {
  append_to_end_any(list, value, FALSE);
}

void m_list_append_to_beginning_set(m_list_t *list,
                                    const m_com_sized_data_t *const value) {
  append_to_beginning_any(list, value, FALSE);
}

void m_list_append_to_end_store(m_list_t *list,
                                const m_com_sized_data_t *const value) {
  append_to_end_any(list, value, TRUE);
}

void m_list_append_to_beginning_store(m_list_t *list,
                                      const m_com_sized_data_t *const value) {
  append_to_beginning_any(list, value, TRUE);
}

void m_list_delete_by_value(m_list_t *list,
                            const m_com_sized_data_t *const value) {
  delete_any_by_value(list, value, FALSE);
}

void m_list_delete_all_by_value(m_list_t *list,
                                const m_com_sized_data_t *const value) {
